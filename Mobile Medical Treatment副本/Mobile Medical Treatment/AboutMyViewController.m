...
- (void)viewDidLoad {
    ...
    type2.name = @"更改密码";
    type2.image = [FirstPageViewController scale:[UIImage imageNamed:@"account_security"] toSize:CGSizeMake(30, 30)];
    
    FunctionType *type3 = [[FunctionType alloc]init];
    type3.name = @"新消息通知";
    type3.image = [FirstPageViewController scale:[UIImage imageNamed:@"noti_news"] toSize:CGSizeMake(30, 30)];
    
    FunctionType *type4 = [[FunctionType alloc]init];
    type4.name = @"关于";
    type4.image = [FirstPageViewController scale:[UIImage imageNamed:@"about"] toSize:CGSizeMake(30, 30)];
